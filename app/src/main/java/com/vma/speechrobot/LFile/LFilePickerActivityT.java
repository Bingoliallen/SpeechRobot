package com.vma.speechrobot.LFile;
...
public class LFilePickerActivityT extends AppCompatActivity {
    ...
    private PathAdapterT mPathAdapter;
   // private Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lfile_picker1);
        ButterKnife.bind(this);

        mParamEntity = (ParamEntity) getIntent().getExtras().getSerializable("param");
        tv_title.setText(mParamEntity.getTitle());
      ...
      /*  setSupportActionBar(mToolbar);
        ...
        mPathAdapter = new PathAdapterT(mListFiles, this, mFilter, mParamEntity.isMutilyMode(), mParamEntity.isGreater(), mParamEntity.getFileSize());
    ...
    private void initListener() {
        ...
        mPathAdapter.setOnItemClickListener(new PathAdapterT.OnItemClickListener() {
            @Override
                ...
                if (mParamEntity.isMutilyMode()) {
                    if (mListFiles.get(position).isDirectory()) {
                        ...
                        if (mParamEntity.getMaxNum() > 0 && mListNumbers.size() > mParamEntity.getMaxNum()) {
                            Toast.makeText(LFilePickerActivityT.this, R.string.lfile_OutSize, Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                } else {
                    ...
                    if (mParamEntity.isChooseMode()) {
                        ...
                        Toast.makeText(LFilePickerActivityT.this, R.string.lfile_ChooseTip, Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            public void onClick(View v) {
                if (mParamEntity.isChooseMode() && mListNumbers.size() < 1) {
                    ...
                    if (TextUtils.isEmpty(info)) {
                        Toast.makeText(LFilePickerActivityT.this, R.string.lfile_NotFoundBooks, Toast.LENGTH_SHORT).show();
                    } else {
