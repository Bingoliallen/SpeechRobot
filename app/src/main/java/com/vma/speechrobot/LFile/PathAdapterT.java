...
public class PathAdapterT extends RecyclerView.Adapter<PathAdapterT.PathViewHolder> {
    ...
    public PathAdapterT(List<File> mListData, Context mContext, FileFilter mFileFilter, boolean mMutilyMode, boolean mIsGreater, long mFileSize) {
    ...
    public PathViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.lfile_listitem1, null);
