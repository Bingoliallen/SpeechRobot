...
public class PieChartView extends View {
  ...
  private void init(AttributeSet attrs, int defStyle) {
    ...
    mTextSize = a.getDimension(R.styleable.PieChartView_textSize, mTextSize) / getResources()
  ...
  private void invalidateTextPaintAndMeasurements() {
    ...
    mTextPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTextSize,
  ...
  protected void onDraw(Canvas canvas) {
    ...
    mPaint.setColor(ContextCompat.getColor(getContext(), R.color.common_app_theme12));
    mPaint.setStyle(Style.STROKE);
    mPaint.setAntiAlias(true);
    mPaint.setStrokeWidth(1);
    RectF rectF = new RectF();
    rectF.set(pieChartCircleRectF.left - ViewUtil.dp2px(getContext(), 10),
        pieChartCircleRectF.top - ViewUtil.dp2px(getContext(), 10),
        pieChartCircleRectF.right + ViewUtil.dp2px(getContext(), 10),
        pieChartCircleRectF.bottom + ViewUtil.dp2px(getContext(), 10));
  ...
  protected void drawSector(Canvas canvas, int color, float startAngle, float sweepAngle) {
    ...
    canvas.drawArc(pieChartCircleRectF, startAngle, sweepAngle, true, mPaint);
  ...
  protected void drawMarkerLineAndText(Canvas canvas, int color, float rotateAngel, String text) {
    ...
    final float x = (float) (getWidth() / 2 + (markerLineLength + pieChartCircleRadius) * Math
        .cos(Math.toRadians(rotateAngel)));
    final float y = (float) (getHeight() / 2 + (markerLineLength + pieChartCircleRadius) * Math
        .sin(Math.toRadians(rotateAngel)));
    path.lineTo(x, y);
    float landLineX;
