...
public class ExpandableLinearLayout extends LinearLayout implements View.OnClickListener {
  ...
  public ExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    fontSize = ta
        .getDimension(R.styleable.ExpandableLinearLayout_tipTextSize, ViewUtil.sp2px(context, 14));
    textColor = ta
        .getColor(R.styleable.ExpandableLinearLayout_tipTextColor, Color.parseColor("#8f8f8f"));
    arrowResId = ta
        .getResourceId(R.styleable.ExpandableLinearLayout_arrowDownImg,
            R.drawable.arrow_down_20_20);
  ...
  private void findViews() {
    bottomView = View.inflate(getContext(), R.layout.ell_bottom_item, null);
   ...
   */
  private void hide() {
    int endIndex = useDefaultBottom ? getChildCount() - 1
        : getChildCount();//如果是使用默认底部，则结束的下标是到底部之前，否则则全部子条目都隐藏
